package com.zhiao.develop.macaumagazine.utils;
...
public class SmoothImageView extends ImageView{
    ...
    public SmoothImageView(Context context, AttributeSet attr) {
        super(context, attr);
        init();
    }

    public SmoothImageView(Context context, AttributeSet attr, int defStyle) {
...
//      setBackgroundColor(mBgColor);
    ...
    private void startTransform(final int state) {
        ...
        if (state == STATE_TRANSFORM_IN) {
            ...
            PropertyValuesHolder alphaHolder = PropertyValuesHolder.ofInt("alpha", 0, 150);
            ...
            PropertyValuesHolder alphaHolder = PropertyValuesHolder.ofInt("alpha", 150, 0);
            valueAnimator.setValues(scaleHolder, leftHolder, topHolder, widthHolder, heightHolder, alphaHolder);
        }
